                ...
                <div className='inner-wrapper flex-row-wrap two-col'>
                    ...
                    <div className='skills-contact-box box'>
                        ...
                        <div id='button_div' className='button_div'>
                            <a class="btn-link" target="_blank" href="https://www.linkedin.com/in/matthew-burtonshaw-9495b1191/">
                                LinkedIn
                            </a>
                            <a class="btn-link" target="_blank" href="https://github.com/MBurtonshaw?tab=repositories">
                                GitHub
                            </a>
                        </div>
                    </div>
