                    ...
                    <div className='inner-wrapper flex-row-wrap two-col'>
                        ...
                        <div className='skills-contact-box box'>
                            <h6 className='indent'>
                                ...
                                <p className='listed'>HTML</p>
                                <p className='listed'>CSS</p>
                                <p className='listed'>Bootstrap</p>
                                <p className='listed'>Javascript</p>
                                <p className='listed'>JQuery</p>
                                <p className='listed'>Node.js</p>
                                <p className='listed'>Fetch and Public APIs</p>
                                <p className='listed'>JSON</p>
                                <p className='listed'>Express</p>
                                <p className='listed'>Pug</p>
                                <p className='listed'>React</p>
                                <p className='listed'>React-Router</p>
                                <p className='listed'>SQL</p>
                            <h6 className='indent'>
                                Contact Info
                            </h6>
                            
                                <p >440-749-2093</p>
                                <p >MBurtonshaw@gmail.com</p>
                            <div id='button_div' className='button_div'>
                                <a class="btn-link" target="_blank" href="https://www.linkedin.com/in/matthew-burtonshaw-9495b1191/">LinkedIn</a>
                                <a class="btn-link" target="_blank" href="https://github.com/MBurtonshaw?tab=repositories">GitHub</a>
                            </div>
                        </div>
                    </div>
                    </article>
