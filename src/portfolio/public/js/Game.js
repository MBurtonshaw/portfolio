...
class Game {
    ...
    removeLife() {
        if (this.activePhrase.checkLetter() === false) {
            this.missed++;
            if (this.missed === 1) {
                hearts[0].src = "./static/img/lostHeart.png";
            } else if (this.missed === 2) {
                hearts[1].src = "./static/img/lostHeart.png";
            } else if (this.missed === 3) {
                hearts[2].src = "./static/img/lostHeart.png";
            } else if (this.missed === 4) {
                hearts[3].src = "./static/img/lostHeart.png";
                alert("You're down to your last heart!");
            } else if (this.missed === 5) {
                hearts[4].src = "./static/img/lostHeart.png";
                this.gameOver();
            }
        }
    }
    ...
    resetGame() {
        ...
        for (let j = 0; j < hearts.length; j++) {
            if ((hearts[j].src = "./static/img/lostHeart.png")) {
                hearts[j].src = "./static/img/liveHeart.png";
            }
        }
    }
}
